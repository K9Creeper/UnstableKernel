...
void (*RebasedBios32Helper)() = reinterpret_cast<void (*)()>(REBASED_OFFSET);

extern "C" void Bios32Helper();
extern "C" void Bios32HelperEnd();

#define REBASE(x) reinterpret_cast<void *>(REBASED_OFFSET + reinterpret_cast<uint32_t>(x) - reinterpret_cast<uint32_t>(Bios32Helper))
